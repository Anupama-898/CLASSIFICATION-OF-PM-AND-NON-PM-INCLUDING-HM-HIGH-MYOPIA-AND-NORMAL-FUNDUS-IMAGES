...
# function to make the model and compile it
	...
	fl1 = base_model.get_layer('flatten_1').output
	...
	fc2=Dense(750,activation='relu')(drop1)
	dropc=Dropout(0.3)(fc2)
	fc21=Dense(500,activation='relu')(dropc)
	drop2=Dropout(0.3)(fc21)
	...
	predictions = Dense(3,activation='softmax')(drop6)
